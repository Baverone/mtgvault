# Dúvidas do inventário por fotos (corrigir no fim)

## Atribuição de SB partilhado (Stiflenought vs UW Replenish)
Estas cartas aparecem no SB dos dois decks azuis; contei-as onde estavam na sequência do binder, mas confirma:
- **Hydroblast** — 2 no Stiflenought + 2 no UW Replenish (foto cac344f4). Total 4 na coleção?
- **Seal of Cleansing** — 2 (cfc8f5d0) + 2 (cac344f4) = 4 no UW Replenish. São 4 mesmo, ou parte é doutro deck?
- **Blue Elemental Blast** — 2 no Stiflenought (aebdd155). Há mais?
- **Tsabo's Web** ×2 (83b30c0d) → pus no UW Replenish (SB).

## Secção VERDE não identificada (fotos f01674dc, 50334c66, ca4a89f7)
Cartas verdes que NÃO batem com nenhum dos 5 decks premodern conhecidos:
- Deranged Hermit ×3, Llanowar Elves ×4, Fyndhorn Elves ×1, Multani's Acolyte ×1, Masticore ×1, Nantuko Vigilante ×1 (nome PT "Justiceiro Nantuko" — confirmar EN).
- **É um deck? Qual? (Elfos premodern? Squirrels?) Ou coleção solta?** Pus tudo em "Verde (por classificar)".
