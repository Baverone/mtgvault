...
def totais_por_board(s: dict) -> dict[str, int]:
    ...
    **Os terrenos básicos ficam de fora** (2026-09-08): saem no bloco próprio
    deles, depois do sideboard, e por isso também não estão no "N". Contá-los só
    no M dava um main eternamente a *"43 de 60"* — 17 cartas que ele nunca ia
    encontrar na lista por cima.
    """
    out: dict[str, int] = defaultdict(int)
    for board, nm, q in s["cards"]:
        if nm in BASICS:
            continue
